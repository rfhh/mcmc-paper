...
First, we present our methodology and findings in parallelizing the
computation using one of several GPUs. A thorough
...
achieves speedups up to 120$times$ compared to an already optimized sequential
version.

Next, we scale this algorithm out towards very large data sets, where memory
