...
GTX~\mbox{Titan-X}, GTX980, K40c and K20m.

To assess the performance of our implementations, we use publicly available
community networks from the SNAP collection~\cite{snapnets}, including the largest
networks. Table~\ref{table-snap}
