\subsection{Restructuring for Parallelism}
...
% Naive strategy
\paragraph*{\textbf{The naive strategy}} simply allocate temporary vectors in thread
...
\paragraph*{\textbf{The shared memory strategy}} allocate the temporary vectors
$Probs_i$ and $Grads_i$
...
\paragraph*{\textbf{The code generation strategy}} dynamically generate the code of the kernel to
