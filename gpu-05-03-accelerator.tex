...
\begin{figure*}[tb]	% [htb]
  ...
  \epsfig{file=plots/titanx-maxwell-1024-strategies-w2.eps, width=0.25\textwidth} &
  \epsfig{file=plots/titanx-maxwell-2048-strategies-w2.eps, width=0.25\textwidth} &
...
Figure \ref{gpu-sweep}(a) presents the performance of the Pascal \mbox{Titan-X} GPU
