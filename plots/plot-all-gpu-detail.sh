...
./plot-gpu-sweep.sh --title "(c) K40c K=1024 no vectorization" k40-1024-strategies-w1 `ls dblp-K1024/TeslaK40c-K1024-M4096-N32-Snode-R0.01-A0.001-C0-*-W1*`
./plot-gpu-sweep.sh --title "(c) K40c K=1024 vector width=2" k40-1024-strategies-w2 `ls dblp-K1024/TeslaK40c-K1024-M4096-N32-Snode-R0.01-A0.001-C0-*-W2*`
./plot-gpu-sweep.sh --title "(c) K40c K=1024 vector width=4" k40-1024-strategies-w4 `ls dblp-K1024/TeslaK40c-K1024-M4096-N32-Snode-R0.01-A0.001-C0-*-W4*`
