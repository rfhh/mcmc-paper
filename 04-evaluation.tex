...
upwards from 256B.
The OpenMPI implementation is highly optimized for Infiband because it has an
ib-verbs implmentation. It requires an interaction between
...
any DKV implementation on top.
This is ample justification for using a low-level RDMA
