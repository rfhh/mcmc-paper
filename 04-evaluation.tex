...
\begin{figure}[htbp] % [htb]
  ...
  \caption{Average execution time per algorithm iteration varying
...
communities proportionally. The number of communities at 64 workers was 12K.
...
loading $\pi$ from the DKV store is domininant.
