...
\begin{figure*}[t] % [htb]
  \centering
  \epsfig{file=plots/hpc-cloud.eps, width=\textwidth}
...
A thorough performance evaluation of our RDMA DKV store is outside the scope of
this paper. In figure~\ref{fig-qperf}, we provide maximum bandwidth numbers for
...
the best achievable preformance for Infiniband. We present \textit{qperf}
...
upwards from 256B. The bandwidth achieved by our DKV store mostly falls short
of the \textit{qperf} performance. For smallish packets, this is attributed
