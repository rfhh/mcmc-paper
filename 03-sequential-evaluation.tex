...
In all implementations, \textit{update\_phi} as given in Equations \ref{eqn:local_update}
and \ref{eqn:local_update_grad} dominates the computation.
...
speedup for these dominant phases grew to a factor~10 on a DAS5 machine.
